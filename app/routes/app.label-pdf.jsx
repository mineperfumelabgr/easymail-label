...
function toPdfBuffer(documentField) {
  ...
  if (documentField && typeof documentField === "object" && Array.isArray(documentField.$values)) {
...
export const loader = async ({ request }) => {
  // ✅ IMPORTANT: app route, quindi resti dentro embedded app
  ...
  try {
    ...
    if (!number) return cors(new Response("Missing number", { status: 400 }));
